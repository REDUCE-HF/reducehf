...
#hf diagnosis
dataset = location(dataset, cohort_index_date)
dataset = time_dependent(dataset, cohort_index_date)
dataset = underserved(dataset, earliest_date, cohort_index_date, end_date)
