...
dataset = wp2_exclude.fn(dataset, earliest_date, dataset.patient_index_date, end_date, objective=1)
...
dataset = underserved.fn(dataset, earliest_date, dataset.first_hfsymptom_date, end_date)
